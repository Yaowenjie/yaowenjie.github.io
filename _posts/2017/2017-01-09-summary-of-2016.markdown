...
## 博客
&emsp;&emsp;2016年，从**4**月份开始，由于网络以及希望自定义博客的原因，决定将博客从yaowenjie.logdown.com迁移到github上。自**4月6号**第一次提交以来，博客逐步添加、完善了一些小功能，发布了**21**篇新的博客文章，其中**16**篇为技术相关的文章。并且于4月份引入[AFS Analytics](https://www.afsanalytics.com/)以来，我就可以关注博客的访问量以及各项数据了。以下，我便罗列了一些关于该博客2016年有趣的数据。
